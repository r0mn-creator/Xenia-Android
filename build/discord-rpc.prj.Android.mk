...
ifeq ($(filter-out ABI=$(TARGET_ARCH_ABI) $(PREMAKE_ANDROIDNDK_CONFIGURATIONS_PREFIXED) $(PREMAKE_ANDROIDNDK_PLATFORMS_PREFIXED),ABI=arm64-v8a CONFIGURATION=Checked PLATFORM=Android-ARM64),)
  ...
  LOCAL_C_INCLUDES := \
    ...
    $(LOCAL_PATH)/../third_party/discord-rpc/include \
    $(LOCAL_PATH)/../third_party/rapidjson/include
  LOCAL_C_INCLUDES := $(call PREMAKE_ANDROIDNDK_SHELL_ESCAPE,$(LOCAL_C_INCLUDES))
  LOCAL_MODULE_FILENAME := libdiscord-rpc
  LOCAL_SRC_FILES := \
    ../third_party/discord-rpc/src/discord_rpc.cpp \
    ../third_party/discord-rpc/src/rpc_connection.cpp \
    ../third_party/discord-rpc/src/serialization.cpp
