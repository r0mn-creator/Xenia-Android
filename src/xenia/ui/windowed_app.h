...
#if XE_PLATFORM_ANDROID
  // Called when the Android activity loses visibility (home button, app switch,
  // or the in-game menu is shown). The emulator should inject a Start button
  // press so the game opens its own pause menu, then suspend emulation threads.
  // Called from the UI thread.
  virtual void OnAndroidSuspend() {}

  // Called when the Android activity regains visibility and the in-game menu
  // has been dismissed. Resume emulation threads. Called from the UI thread.
  virtual void OnAndroidResume() {}
