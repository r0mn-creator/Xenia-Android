...
// Return kInvalid quietly for unrecognized words. The PPC scanner is designed
// to encounter and ignore invalid instructions (data/padding interspersed with
// code, e.g. jump/thunk tables) — see ppc_scanner.cc, which logs and continues
// on PPCOpcode::kInvalid. A hard assert here is a too-aggressive debug tripwire
// that aborts on perfectly normal content; release Xenia just returns kInvalid.
